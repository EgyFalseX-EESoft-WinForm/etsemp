...
{
    public partial class tblbadalatFrm : XtraForm
    {
        ...
        {
            LSMSData.QueryableSource = from q in dsLinq.vtblbadalats select q;
            //ActivePriv();
        }
        ...
        private void repositoryItemButtonEditSave_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            Datasource.dsLinq.vtblbadalat row = (Datasource.dsLinq.vtblbadalat)GV.GetRow(GV.FocusedRowHandle);
            tblbadalatEditFrm frm = new tblbadalatEditFrm(row);
        ...
        {
            tblbadalatAddFrm frm = new tblbadalatAddFrm();
            if (frm.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                LSMSData.Reload();
